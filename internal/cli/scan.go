...
func init() {
	...
	scanCmd.Flags().StringVar(&scanReviewModelName, "review-model", "", "Model for review tasks (summarize, review, quick review)")
	scanCmd.Flags().StringVar(&scanOrderModelName, "order-model", "", "Model for file ordering")
